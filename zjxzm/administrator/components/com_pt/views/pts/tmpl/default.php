...
<form action="<?php echo JRoute::_('index.php?option=com_pt&view=pts'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php else : ?>
		...
		<table class="table table-striped" id="eventList">
			<thead>
				<tr>
					...
					<th width="1%" class="nowrap center" style="min-width:50px">
						<?php echo JHtml::_('grid.sort', '类别名称', 'a.name', $listDirn, $listOrder); ?>
					</th>

					<th width="1%" class="nowrap center" style="min-width:50px">
						<?php echo JHtml::_('grid.sort', '所属商品类别', 'a.tname', $listDirn, $listOrder); ?>
					</th>
			...
			<?php foreach($this->items as $i => $item) :
				...
				$canChange = $user->authorise('core.edit.state','com_pt') && $canCheckin;
				?>
...
<!--				--><?php
//				$sql = "select name,id from #__pt where typeid =  $item->typeid";
//				$db->setQuery($sql);
...
<!--					<tr>-->
<!--						<td class="center hidden-phone">-->
<!--							--><?php //echo JHtml::_('grid.id', $i, $v['id']); ?>
<!--						</td>-->
<!--						<td class="center hidden-phone">-->
<!--								--><?php //echo str_repeat('&nbsp',25).$v['name'] ?>
<!--						</td>-->
<!--						<td class="center hidden-phone">-->
<!--							--><?php //echo $v['id'] ?>
<!--						</td>-->
