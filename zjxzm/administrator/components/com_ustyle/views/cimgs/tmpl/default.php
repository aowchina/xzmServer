...
<form action="<?php echo JRoute::_('index.php?option=com_ustyle&view=cimgs'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="filter-bar" class="btn-toolbar">
         	<div class="filter-search btn-group pull-left">
           		...
           		<input type="text" name="filter_search" id="filter_search" 
           			placeholder="<?php echo JText::_('COM_USTYLE_SEARCH_IN_TITLE'); ?>"
   					value="<?php echo $this->escape($this->state->get('filter.search'));?>" 
   					title="<?php echo JText::_('COM_USTYLE_SEARCH_IN_TITLE'); ?>" />
         	</div>
			...
			<thead>
				<tr>
					...
					<th width="10%" class="nowrap center hidden-phone">
            			<?php echo JHtml::_('grid.sort', '编号', 'a.imgid', $listDirn, $listOrder); ?>
            		</th>

            		<th width="10%" class="nowrap center hidden-phone">
            			<?php echo JHtml::_('grid.sort', '所属车款', "b.cname", $listDirn, $listOrder); ?>
            		</th>

            		<th width="15%" class="nowrap center hidden-phone">
            			<?php echo JHtml::_('grid.sort', '车款图片', "a.carimage", $listDirn, $listOrder); ?>
            		</th>
			...
			<?php foreach($this->items as $i => $item) :?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center hidden-phone">
						<?php echo JHtml::_('grid.id', $i, $item->imgid); ?>
					</td>

					<td class="center">
						<?php echo $this->escape($item->imgid); ?>
					</td>
						...
						<div class="piclist">
							<ul>
								<li class="pic">
									<div class="in">
										<div class="imgdiv">
											<img src="<?php echo "http://".$_SERVER['HTTP_HOST']."/".$item->carimage;?>" />
										</div>
									</div>
								</li>
							</ul>
