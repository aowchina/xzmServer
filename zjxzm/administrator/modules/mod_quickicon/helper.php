		...
		if (!isset(self::$buttons[$key]))
		{
			...
			if ($context == 'mod_quickicon')
			{
				...
				self::$buttons[$key] = array(
					array(
						'link' => JRoute::_('index.php?option=com_epc'),
						'image' => 'pencil-2',
						'icon' => 'header/icon-48-article-add.png',
						'text' => JText::_('MOD_QUICKICON_ADD_NEW_ARTICLE'),
						'access' => array('core.manage', 'com_content', 'core.create', 'com_epc'),
						'group' => 'MOD_QUICKICON_CONTENT'
					),
					array(
						'link' => JRoute::_('index.php?option=com_type'),
						'image' => 'stack',
					...
					array(
						'link' => JRoute::_('index.php?option=com_ustyle'),
						'image' => 'folder',
					...
					array(
						'link' => JRoute::_('index.php?option=com_shop'),
						'image' => 'pictures',
					...
					array(
						'link' => JRoute::_('index.php?option=com_appuser'),
						'image' => 'cube',
						'icon' => 'header/icon-48-module.png',
						'text' => JText::_('MOD_QUICKICON_APPUSER_MANAGER'),
						'access' => array('core.manage', 'com_appuse'),
						'group' => 'MOD_QUICKICON_USERS'
					),
					array(
						'link' => JRoute::_('index.php?option=com_service'),
						'image' => 'users',
						'icon' => 'header/icon-48-user.png',
						'text' => JText::_('MOD_QUICKICON_KEFUUSER_MANAGER'),
						'access' => array('core.manage', 'com_servic'),
						'group' => 'MOD_QUICKICON_USERS'
					),
					array(
						'link' => JRoute::_('index.php?option=com_seller'),
						'image' => 'users',
						'icon' => 'header/icon-48-user.png',
						'text' => JText::_('MOD_QUICKICON_SELLERUSER_MANAGER'),
						'access' => array('core.manage', 'com_seller'),
						'group' => 'MOD_QUICKICON_USERS'
					)
					// array(
