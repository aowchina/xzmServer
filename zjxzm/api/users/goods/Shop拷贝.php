...
$sql = "select a.goodid,a.name,a.price,a.img,b.name as tname from zj_good as a left join zj_pt as b on a.typeid = b.id where $where limit $offset,10";
...
$count = dbCount('zj_good', $con, "shopid = $shopid");
$allCount = intval($count);
$data['allGoods'] = $allList;
$data['allCount'] = $allCount;

//店铺的新品(默认添加时间倒叙前10个)
$sql = "select a.goodid,a.name,a.price,a.img,b.name as tname from zj_good as a left join zj_pt as b on a.typeid = b.id where $where order by a.addtime limit 10";
