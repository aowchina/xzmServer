...
$offset = ($page - 1) * 10;
$sql = "select bid, appuid, bname, sname, cname, jname, picture, type from  zj_border where appuid = $userid ORDER by bid desc limit $offset,10";
...
foreach($Buylist as &$v)
{
    ...
    $count = dbCount('zj_setmoney', $con,  "bid =$v[bid]");
    $v['count'] = $count;
}
