...
//取出好友id
$sql = "select sid from zj_friends where aid = $userid";
...
$sql = "select * from zj_seller where sellerid in (".implode(',',$ids).") order by sellerid ".$limit;
