...
$sql = "select price,type,pid from zj_qgorder where qgorderid = '$orderid'";
...
//算总价
$prices = explode(',',$order_info['price']);
...
if(!dbUpdate($data, 'zj_qgorder', $con, "qgorderid = '$orderid'"))
{
    forExit($lock_array, $con);
...
$req['out_trade_no'] = $orderid;//这里之前用的是payid
