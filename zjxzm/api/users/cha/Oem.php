...
if($count>=1){
    $sql="select a.name,e.bname,a.oem,a.price,a.img,a.goodid from zj_good a
left join zj_type b on a.typeid=b.typeid
left join zj_car c on b.carid=c.carid
left join zj_serial d on c.serialid=d.serialid
left join zj_brand e on e.brandid=d.brandid
