...
//   var_dump($apiParams,$sysParams);
		//系统参数放入GET请求串

    $time=time();
//		$aaa=urlencode('alipay_sdk=alipay-sdk-php-20161101&method=alipay.fund.trans.toaccount.transfer&app_id = 2016050501366144&version = 1.0&sign_type = RSA&sign=RN/iY1Z+L9gWihYXhhJmJFsKFh+McXUmhmjPykEFG0k3oUt8gn8OYOk4QuItmxa2iMNCWaaRwCNS10DczS2YD2K65RC+o1UxbWKjGYQuJjjt8QDGizg6r41FFClNt2vrdy3DvD8hcPIwha2Er3j0FRSq5ulUMciJKaefYecEudI=&timestamp=2013-01-01 08:08:08&charset=utf-8&format=json&biz_content("{"out_biz_no":"hd".$time,"payee_type":"ALIPAY_USERID","payee_account":"abc@sina.com","amount":"12.23","ext_param":"{"order_title":"提现"}"}")');
