...
//   curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
    curl_setopt($ch,CURLOPT_SSLCERT,getcwd().'/apiclient_cert2.pem');
//    curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
    curl_setopt($ch,CURLOPT_SSLKEY,getcwd().'/apiclient_key2.pem');
...
//拼接企业转账参数
 $req['mch_appid']="wx4d9f692ef2985664";
 $req['mchid']='1481528832';
