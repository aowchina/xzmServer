...
/**
 * 添加收货地址
 * 接口参数：8段 * userid * 姓名(需转) * 手机号 * 省id * 市id * 区id * 详细地址(需转)
 * author pwj
 * date 2017-06-03
 */
...
//验重
$condition = "userid = $userid and pid = $pid and cid = $cid and pid = $aid and address = '".$address."' and is_app = 1";
...
if(!dbAdd($data, 'zj_user_address', $con)){
    forExit($lock_array, $con);
