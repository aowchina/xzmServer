...
//提现记录表是否有此用户记录
$condition = "userid = '$userid' and tid=1 order by addtime desc".$limit;
$count = dbCount('zj_wrecord', $con, $condition);
if($count>=1){
    $sql="select * from zj_wrecord where $condition";
