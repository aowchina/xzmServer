...
$count = dbCount("zj_user_address", $con, "userid = $userid and id = $address_id and is_app = 0");
if($count != 1){
    forExit($lock_array, $con);
...
//验重
$condition = "userid = $userid and is_app = 0 and pid = $pid and cid = $cid and aid = $aid and address = '".$address."' and id <> $address_id";
...
if(!dbUpdate($data, 'zj_user_address', $con, "userid = $userid and id = $address_id and is_app = 0")){
    forExit($lock_array, $con);
